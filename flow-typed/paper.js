...
declare type NativeMouseEvent = TMouseEvent;
declare module 'paper' {
     ...
     * Please note: Using this method may override native constructors (e.g. TPath, RGBColor). This may cause problems when using Paper.js in conjunction with other libraries that rely on these constructors. Keep the library scoped if you encounter issues caused by this.
     * @param  -
     */
    declare export function install(scope: any): void

    /**
     * Sets up an empty project for us. If a canvas is provided, it also creates a TView for it, both linked to this scope.
     * @param  - the HTML canvas element this scope should be associated with, or an ID string by which to find the element.
     */
    ...
    */
    declare export class TMatrix {

        /**
         * Creates a 2D affine transform.
         * @param  - the a property of the transform
         * @param  - the c property of the transform
         * @param  - the b property of the transform
         * @param  - the d property of the transform
         * @param  - the tx property of the transform
         * @param  - the ty property of the transform
         */
         ...
         * @param  - the ty property of the transform
         */
        set(a: number, c: number, b: number, d: number, tx: number, ty: number): TMatrix;
         ...
         * @param  - the matrix to compare this matrix to
         */
        equals(matrix: TMatrix): boolean;
         ...
         * @param  - controls whether to apply transformations recursively on children
         */
        apply(): boolean;

        /**
         * Concatenates this transform with a translate transformation.
         * @param  - the vector to translate by
         */
        translate(point: TPoint): TMatrix;

        /**
         * Concatenates this transform with a translate transformation.
         * @param  - the distance to translate in the x direction
         * @param  - the distance to translate in the y direction
         */
        translate(dx: number, dy: number): TMatrix;

        /**
         * Concatenates this transform with a scaling transformation.
         * @param  - the scaling factor
         * @param  [optional] - the center for the scaling transformation
         */
        scale(scale:number, center?:TPoint) :TMatrix;

        /**
         * Concatenates this transform with a scaling transformation.
         * @param  - the horizontal scaling factor
         * @param  - the vertical scaling factor
         * @param  [optional] - the center for the scaling transformation
         */
        scale(hor: number, ver: number, center?: TPoint): TMatrix;

        /**
         * Concatenates this transform with a rotation transformation around an anchor point.
         * @param  - the angle of rotation measured in degrees
         * @param  - the anchor point to rotate around
         */
        rotate(angle: number, center?: TPoint): TMatrix;

        /**
         * Concatenates this transform with a rotation transformation around an anchor point.
         * @param  - the angle of rotation measured in degrees
         * @param  - the x coordinate of the anchor point
         * @param  - the y coordinate of the anchor point
         */
        rotate(angle: number, x: number, y: number): TMatrix;

        /**
         * Concatenates this transform with a shear transformation.
         * @param  - the shear factor in x and y direction
         * @param  [optional] - the center for the shear transformation
         */
        shear(shear: TPoint, center?: TPoint): TMatrix;

        /**
         * Concatenates this transform with a shear transformation.
         * @param  - the horizontal shear factor
         * @param  - the vertical shear factor
         * @param  [optional] - the center for the shear transformation
         */
        shear(hor: number, ver: number, center?: TPoint): TMatrix;

        /**
         * Concatenates this transform with a skew transformation.
         * @param  - the skew angles in x and y direction in degrees
         * @param  [optional] - the center for the skew transformation
         */
        skew(skew: TPoint, center?: TPoint): TMatrix;

        /**
         * Concatenates this transform with a skew transformation.
         * @param  - the horizontal skew angle in degrees
         * @param  - the vertical skew angle in degrees
         * @param  [optional] - the center for the skew transformation
         */
        skew(hor: number, ver: number, center?: TPoint): TMatrix;

        /**
         * Concatenates the given affine transform to this transform.
         * @param  - the transform to concatenate
         */
        concatenate(mx: TMatrix): TMatrix;

        /**
         * Pre-concatenates the given affine transform to this transform.
         * @param  - the transform to preconcatenate
         */
        preConcatenate(mx: TMatrix): TMatrix;

        /**
         * Returns a new instance of the result of the concatenation of the given affine transform with this transform.
         * @param  - the transform to concatenate
         */
        chain(mx: TMatrix): TMatrix;
         ...
         * @param  - the array containing the source points as x, y value pairs
         * @param  - the array into which to store the transformed point pairs
         * @param  - the number of points to transform
         */
         ...
         * @param  - the point to be transformed
         */
        inverseTransform(point: TPoint): TPoint;
    ...
    /**
     * The TPoint object represents a point in the two dimensional space of the Paper.js project. It is also used to represent two dimensional vector objects.
     */
    declare export class TPoint {
         ...
         * @param  -
         */
        min(point1: TPoint, point2: TPoint): TPoint;
         ...
         * @param  -
         */
        max(point1: TPoint, point2: TPoint): TPoint;
        ...
        /**
         * Creates a TPoint object with the given x and y coordinates.
        ...
        /**
         * Creates a TPoint object using the numbers in the given array as coordinates.
         * @param  - an array of numbers to use as coordinates
         */
        constructor(values: number[]): this;

        /**
         * Creates a TPoint object using the properties in the given object.
         * @param  - the object describing the point's properties
         */
        constructor(object: any): this;

        /**
         * Creates a TPoint object using the width and height values of the given TSize object.
         * @param  - the size width and height to use
         */
        constructor(size: TSize): this;

        /**
         * Creates a TPoint object using the coordinates of the given TPoint object.
         * @param  - the point to copy
         */
        constructor(point: TPoint): this;
        ...
        */
         ...
         * @param  : TPoint
         */
        getAngleInRadians(point: TPoint): number;
         ...
         * @param  -
         */
        getDirectedAngle(point: TPoint): number;

        /**
         * Returns the distance between the point and another point.
         * @param  -
         * @param  [optional] - Controls whether the distance should remain squared, or its square root should be calculated. default: false
         */
        getDistance(point: TPoint, squared?: boolean): number;
         ...
         * @param  [optional] - The length of the normalized vector, default: 1
         */
        normalize(length?: number): TPoint;
         ...
         * @param  - the center point of the rotation
        */
        rotate(angle: number, center?: TPoint): TPoint;

        /**
         * Transforms the point by the matrix as a new point. The object itself is not modified!
         * @param  -
         */
        transform(matrix: TMatrix): TPoint;

        /**
         * Checks whether the point is inside the boundaries of the rectangle.
         * @param  - the rectangle to check against
         */
        isInside(rect: TRectangle): boolean;

        /**
         * Checks if the point is within a given distance of another point.
         * @param  - the point to check against
         * @param  - the maximum distance allowed
         */
        isClose(point: TPoint, tolerance: number): boolean;

        /**
         * Checks if the vector represented by this point is colinear (parallel) to another vector.
         * @param  - the vector to check against
         */
        isColinear(point: TPoint): boolean;

        /**
         * Checks if the vector represented by this point is orthogonal (perpendicular) to another vector.
         * @param  - the vector to check against
         */
        isOrthogonal(point: TPoint): boolean;
         ...
         * @param  -
         */
        dot(point: TPoint): number;

        /**
         * Returns the cross product of the point and another point.
         * @param  -
         */
        cross(point: TPoint): number;
        ...
        add(point: number[]): TPoint;
        subtract(point: TPoint): TPoint;
        subtract(point: number[]): TPoint;
        multiply(point: TPoint): TPoint;
        multiply(point: number[]): TPoint;
        multiply(point: number): TPoint;
        divide(point: TPoint): TPoint;
        divide(point: number[]): TPoint;
        divide(point: number): TPoint
    }

    /**
     * A TRectangle specifies an area that is enclosed by it's top-left point (x, y), its width, and its height. It should not be confused with a rectangular path, it is not an item.
     */
    declare export class TRectangle {

        /**
         * Creates a TRectangle object.
         * @param  - the top-left point of the rectangle
         * @param  - the size of the rectangle
         */
        constructor(point: TPoint, size: TSize): this;
        ...
        /**
         * Creates a TRectangle object.
         * @param  - an object containing properties to be set on the rectangle.
         */
        constructor(object: any): this;
         ...
         * @param  - The first point defining the rectangle
         * @param  - The second point defining the rectangle
         */
        constructor(from: TPoint, to: TPoint): this;

        /**
         * Creates a new rectangle object from the passed rectangle object.
         * @param  - the rectangle to copy from
         */
        constructor(rt: TRectangle): this;
         ...
         * @param  - the rectangle to check against
         */
        equals(rect: TRectangle): boolean;
         ...
         * @param  - the specified rectangle
         */
        intersects(rect: TRectangle): boolean;

        /**
         * Returns a new rectangle representing the intersection of this rectangle with the specified rectangle.
         * @param  - The rectangle to be intersected with this rectangle
         */
        intersect(rect: TRectangle): TRectangle;

        /**
         * Returns a new rectangle representing the union of this rectangle with the specified rectangle.
         * @param  - the rectangle to be combined with this rectangle
         */
        unite(rect: TRectangle): TRectangle;
         ...
         * @param  - the point to add to the rectangle
        */
        include(point: TPoint): TRectangle;

        /**
         * Expands the rectangle by the specified amount in horizontal and vertical directions.
         * @param  - the amount to expand the rectangle in both directions
         */
        expand(amount: number | TSize | TPoint): TRectangle;

        /**
         * Expands the rectangle by the specified amounts in horizontal and vertical directions.
         * @param  - the amount to expand the rectangle in horizontal direction
         * @param  - the amount to expand the rectangle in vertical direction
         */
        expand(hor: number, ver: number): TRectangle;

        /**
         * Scales the rectangle by the specified amount from its center.
         * @param  - the amount to scale by
         */
        scale(amount: number): TRectangle;
         ...
         * @param  - the amount to scale the rectangle in horizontal direction
         * @param  - the amount to scale the rectangle in vertical direction
         */
        scale(hor: number, ver: number): TRectangle
    }

    /**
     * The TSize object is used to describe the size or dimensions of something, through its width and height properties.
     */
    declare export class TSize {

        /**
         * Returns a new size object with the smallest width and height of the supplied sizes.
         * @param  - the first size
         * @param  - the second size
         */
        min(size1: TSize, size2: TSize): TSize;
         ...
         * @param  - the second size
         */
        max(size1: TSize, size2: TSize): TSize;
        ...
        /**
         * Creates a TSize object with the given width and height values.
         * @param  - the width
         * @param  - the height
         */
        ...
        /**
         * Creates a TSize object using the numbers in the given array as dimensions.
         * @param  - an array of numbers
         */
        constructor(array: number[]): this;

        /**
         * Creates a TSize object using the properties in the given object.
         * @param  - the object literal containing properies (width:10, height:10 etc)
         */
        constructor(object: any): this;

        /**
         * Creates a TSize object using the coordinates of the given TSize object.
         * @param  - the size to duplicate from
         */
        constructor(size: TSize): this;

        /**
         * Creates a TSize object using the point.x and point.y values of the given TPoint object.
         * @param  - the point from which to create a size
         */
        constructor(point: TPoint): this;
         ...
         */
        abs(): TSize;
        add(size: TSize): TSize;
        add(size: number[]): TSize;
        subtract(size: TSize): TSize;
        subtract(size: number[]): TSize;
        multiply(size: TSize): TSize;
        multiply(size: number[]): TSize;
        multiply(size: number): TSize;
        divide(size: TSize): TSize;
        divide(size: number[]): TSize;
        divide(size: number): TSize
    }
    ...
    */
    ...
    /**
     * The TItem type allows you to access and modify the items in Paper.js projects. Its functionality is inherited by different project item types such as TPath, CompoundPath, TGroup, Layer and Raster. They each add a layer of functionality that is unique to their type, but share the underlying properties and functions that they inherit from TItem.
     */
    declare export class TItem {
         ...
         * String('TGroup', 'Layer', 'TPath', 'CompoundPath', 'TShape', 'Raster', 'PlacedSymbol', 'TPointText')
         */
        className: string;
        ...
        /**
         * Specifies whether the item is selected. This will also return true for TGroup items if they are partially selected, e.g. groups containing selected or partially selected paths.
         ...
         */
        strokeBounds: TRectangle;

        /**
         * The bounding rectangle of the item including handles.
         */
        handleBounds: TRectangle;
        ...
        /**
         * Controls whether the transformations applied to the item (e.g. through transform(matrix), rotate(angle), scale(scale), etc.) are stored in its matrix property, or whether they are directly applied to its contents or children (passed on to the segments in TPath items, the children of TGroup items, etc.).
         */
        applyMatrix: boolean;
        ...
        /**
         * The shape to be used at the beginning and end of open TPath items, when they have a stroke.
         * String('round', 'square', 'butt')
         */
        strokeCap: string;

        /**
         * The shape to be used at the segments and corners of TPath items when they have a stroke.
        ...
        /**
         * TItem level handler function to be called on each frame of an animation.
         * The function receives an event object which contains information about the frame event:
         */
        onFrame: (event: IFrameEvent) => void;

        /**
         * The function to be called when the mouse button is pushed down on the item. The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onMouseDown: (event: TMouseEvent) => void;

        /**
         * The function to be called when the mouse position changes while the mouse is being dragged. The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onMouseDrag: (event: TMouseEvent) => void;

        /**
         * The function to be called when the mouse button is released over the item.
         * The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onMouseUp: (event: TMouseEvent) => void;

        /**
         * The function to be called when the mouse clicks on the item. The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onClick: (event: TMouseEvent) => void;

        /**
         * The function to be called when the mouse double clicks on the item. The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onDoubleClick: (event: TMouseEvent) => void;

        /**
         * The function to be called repeatedly when the mouse moves on top of the item. The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onMouseMove: (event: TMouseEvent) => void;

        /**
         * The function to be called when the mouse moves over the item. This function will only be called again, once the mouse moved outside of the item first. The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onMouseEnter: (event: TMouseEvent) => void;

        /**
         * The function to be called when the mouse moves out of the item.
         * The function receives a TMouseEvent object which contains information about the mouse event.
         */
        onMouseLeave: (event: TMouseEvent) => void;
         ...
         * @param  [optional] - object with 2 parameters
        ...
        */
         ...
         * @param  - the item or project to copy the item to
         */
        copyTo(item: TItem): TItem;

        /**
         * Rasterizes the item into a newly created Raster object. The item itself is not removed after rasterization.
         * @param  [optional] - the resolution of the raster in pixels per inch (DPI). If not specified, the value of view.resolution is used. default: view.resolution
         */
        ...
        /**
         *
         * @param  - the item to check against
         */
        intersects(item: TItem): boolean;
         ...
         * @param  - the point where the hit-test should be performed
         * @param  -the tolerance of the hit-test in points. Can also be controlled through paperScope.settings.hitTolerance
         * @param  - only hit-test again a certain item class and its sub-classes: TGroup, Layer, TPath, CompoundPath, TShape, Raster, PlacedSymbol, TPointText, etc.
         ...
         * @param  - hit-test for segment.point of TPath items.
         ...
         * @param  - hit-test items that have TItem#guide set to true.
         ...
         * @param  - the criteria to match against.
         */
         ...
         * @param  - the name of the state to match against.
         * @param  - the value, function or regular expression to compare against.
         */
        ...
        */
         ...
         * @param  [optional] the export options, default: { asString: false, precision: 5, matchShapes: false }
         ...
         * Note that the project is not cleared first. You can call project.clear() to do so.
         * @param  - the SVG content to import
         * @param  [optional] - the import options, default: { expandShapes: false }
         * @param  - whether imported shape items should be expanded to path items.
         */
        importSVG(svg: SVGElement | string, options?: any): TItem;
         ...
         * @param  - the item to add as a child
         */
        addChild(item: TItem): TItem;
         ...
         * @param  - the index
         * @param  - the item to be inserted as a child
         */
        insertChild(index: number, item: TItem): TItem;
         ...
         * @param  - The items to be added as children
         */
        addChildren(items: TItem[]): TItem[];
         ...
         * @param  -
         * @param  - The items to be appended as children
         */
        insertChildren(index: number, items: TItem[]): TItem[];

        /**
         * Inserts this item above the specified item.
         * @param  - the item above which it should be inserted
         */
        insertAbove(item: TItem): TItem;

        /**
         * Inserts this item below the specified item.
         * @param  - the item below which it should be inserted
         */
        insertBelow(item: TItem): TItem;

        /**
         * Moves this item above the specified item. Returns true if the item
         * was moved.
         * @param  - the item above which it should be moved
         */
        moveAbove(item: TItem): boolean;

        /**
         * Moves this item below the specified item. Returns true if the item
         * was moved.
         * @param  - the item below which it should be moved
         */
        moveBelow(item: TItem): boolean;
         ...
         * @param  - the item to replace this one with
         */
        replaceWith(item: TItem): boolean;

        /**
         * Removes all of the item's children (if any).
         */
        removeChildren(): TItem[];
         ...
         * @param  [optional] - the ending index, exclusive, default: children.length
         */
        removeChildren(from: number, to?: number): TItem[];
        ...
        /**
         * Specifies whether the item has any content or not. The meaning of what content is differs from type to type. For example, a TGroup with no children, a TTextItem with no text content and a TPath with no segments all are considered empty.
         */
        isEmpty(): boolean;
         ...
         * @param  - The item to check against
         */
        isAbove(item: TItem): boolean;

        /**
         * Checks if the item is below the specified item in the stacking order of the project.
         * @param  - The item to check against
         */
        isBelow(item: TItem): boolean;

        /**
         * Checks whether the specified item is the parent of the item.
         * @param  - The item to check against
         */
        isParent(item: TItem): boolean;

        /**
         * Checks whether the specified item is a child of the item.
         * @param  - The item to check against
         */
        isChild(item: TItem): boolean;

        /**
         * Checks if the item is contained within the specified item.
         * @param  - The item to check against
         */
        isDescendant(item: TItem): boolean;

        /**
         * Checks if the item is an ancestor of the specified item.
         * @param  - the item to check against
         */
        isAncestor(item: TItem): boolean;

        /**
         * Checks whether the item is grouped with the specified item.
         * @param  -
         */
        isGroupedWith(item: TItem): boolean;

        /**
         * Translates (moves) the item by the given offset point.
         * @param  - the offset to translate the item by
         */
        translate(delta: TPoint): TPoint;

        /**
         * Rotates the item by a given angle around the given point.
         * Angles are oriented clockwise and measured in degrees.
         * @param  - the rotation angle
         * @param  [optional] - default: item.position
         */
        rotate(angle: number, center?: TPoint): void;
         ...
         * @param  [optional] - default: item.position
         */
        scale(scale: number, center?: TPoint): void;

        /**
         * Scales the item by the given values from its center point, or optionally from a supplied point.
         * @param  - the horizontal scale factor
         * @param  - the vertical scale factor
         * @param  [optional] - default: item.position
         */
        scale(hor: number, ver: number, center?: TPoint): void;

        /**
         * Shears the item by the given value from its center point, or optionally by a supplied point.
         * @param  - the horziontal and vertical shear factors as a point
         * @param  [optional] - default: item.position
         */
        shear(shear: number, center?: TPoint): void;
         ...
         * @param  [optional] - default: item.position
         */
        shear(hor: number, ver: number, center?: TPoint): void;

        /**
         * Skews the item by the given angles from its center point, or optionally by a supplied point.
         * @param  - the horziontal and vertical skew angles in degrees
         * @param  [optional] - default: item.position
         */
        skew(skew: TPoint, center?: TPoint): void;

        /**
         * Skews the item by the given angles from its center point, or optionally by a supplied point.
         * @param  - the horizontal skew angle in degrees
         * @param  - the vertical sskew angle in degrees
         * @param  [optional] - default: item.position
         */
        skew(hor: number, ver: number, center?: TPoint): void;

        /**
         * Transform the item.
         * @param  - the matrix by which the item shall be transformed.
         */
        transform(matrix: TMatrix): void;

        /**
         * Converts the specified point from global project coordinate space to the item's own local coordinate space.
         * @param  - the point to be transformed
         */
        globalToLocal(point: TPoint): TPoint;

        /**
         * Converts the specified point from the item's own local coordinate space to the global project coordinate space.
         * @param  - the point to be transformed
         */
        localToGlobal(point: TPoint): TPoint;

        /**
         * Converts the specified point from the parent's coordinate space to item's own local coordinate space.
         * @param  - the point to be transformed
         */
        parentToLocal(point: TPoint): TPoint;

        /**
         * Converts the specified point from the item's own local coordinate space to the parent's coordinate space.
         * @param  - the point to be transformed
         */
        localToParent(point: TPoint): TPoint;

        /**
         * Transform the item so that its bounds fit within the specified rectangle, without changing its aspect ratio.
         * @param  -
         * @param  [optiona;] - default = false
         */
        fitBounds(rectangle: TRectangle, fill?: boolean): void;

        /**
         * Attach an event handler to the tool.
         * @param  - String('mousedown'|'mouseup'|'mousedrag'|'mousemove'|'keydown'|'keyup') the event type
         * @param  - The function to be called when the event occurs
         */
        on(type: string, callback: (event: ToolEvent) => void): Tool;

        /**
         * Attach one or more event handlers to the tool.
         * @param  - an object literal containing one or more of the following properties: mousedown, mouseup, mousedrag, mousemove, keydown, keyup
         */
        on(param: any): Tool;
         ...
         * @param  - String('mousedown'|'mouseup'|'mousedrag'|'mousemove'|'keydown'|'keyup') the event type
         * @param  - The function to be detached
         */
         ...
         * @param  - String('mousedown'|'mouseup'|'mousedrag'|'mousemove'|'keydown'|'keyup') the event type
         * @param  - an object literal containing properties describing the event.
         */
         ...
         * @param  - The function to be called when the event occurs
         */
        on(type: string, callback: () => void): TItem;
         ...
         * @param  - The function to be detached
         */
        off(type: string, callback: (event: ToolEvent) => void): TItem;
         ...
         * @param  - The object literal can contain the following values
    ...
    /**
     * A TGroup is a collection of items. When you transform a TGroup, its children are treated as a single unit without changing their relative positions.
     */
    declare export class TGroup mixins TItem {

        /**
         * Creates a new TGroup item and places it at the top of the active layer.
         * @param  [optional] - An array of TItem Objects children that will be added to the newly created group.
         */
        constructor(children?: TItem[]): this;

        /**
         * Creates a new TGroup item and places it at the top of the active layer.
         * @param  [optional] - an object literal containing the properties to be set on the group.
         */
        constructor(object?: any): this;
    ...
    */
    declare export class Layer mixins TGroup {
         ...
         * @param  [optional] - An array of Items that will be added to the newly created layer.
         */
        constructor(children?: TItem[]): this;

        /**
         * Creates a new Layer item and places it at the end of the project.layers array. The newly created layer will be activated, so all newly created items will be placed within it.
         * @param  [optional] - an object literal containing the properties to be set on the layer.
         */
        constructor(object?: any): this;
    ...
    declare export class TShape mixins TItem {

        /**
         * Creates a circular shape item.
         * @param  - the center point of the circle
         * @param  - the radius of the circle
         */
        TCircle(center: TPoint, radius: number): TShape;

        /**
         * Creates a circular shape item from the properties described by an object literal.
         * @param  - an object literal containing properties descriving the shapes attributes
         */
        TCircle(object: any): TShape;

        /**
         * Creates a rectangular shape item, with optionally rounded corners.
         * @param  - the rectangle object describing the geometry of the rectangular shape to be created.
         * @param  [optional] - the size of the rounded corners, default: null
         */
        TRectangle(rectangle: TRectangle, radius?: number): TShape;

        /**
         * Creates a rectangular shape item from a point and a size object.
         * @param  - the rectangle's top-left corner
         * @param  - the rectangle's size.
         */
        TRectangle(point: TPoint, size: TSize): TShape;
         ...
         * @param  - the second point defining the rectangle
         */
        TRectangle(from: TPoint, to: TPoint): TShape;

        /**
         * Creates a rectangular shape item from the properties described by an object literal.
         * @param  - an object literal containing properties describing the shape's attributes
         */
        TRectangle(object: any): TShape;

        /**
         * Creates an elliptical shape item.
         * @param  - the rectangle circumscribing the ellipse
         */
        Ellipse(rectangle: TRectangle): TShape;

        /**
         * Creates an elliptical shape item from the properties described by an object literal.
         * @param  - an object literal containing properties describing the shape's attributes
         */
        Ellipse(object: any): TShape;
     ...
     */
    declare export class Raster mixins TItem {
         ...
         * @param  [optional] - the source of the raster
         * @param  [optional] - the center position at which the raster item is placed
         */
        constructor(source?: HTMLImageElement | HTMLCanvasElement | string, position?: TPoint): this;
         ...
         * @param  - the boundaries of the sub image in pixel coordinates
         */
        getSubCanvas(rect: TRectangle): HTMLCanvasElement;
         ...
         * @param  - the boundaries of the sub raster in pixel coordinates
         */
        getSubRaster(rect: TRectangle): Raster;
         ...
         * @param  - the offset of the image as a point in pixel coordinates
         */
        drawImage(image: HTMLImageElement | HTMLCanvasElement, point: TPoint): void;
         ...
         * @param  - the path, rectangle or point to get the average image color from
         */
        getAverageColor(object: TPath | TRectangle | TPoint): Color;

        /**
         * Gets the color of a pixel in the raster.
         * @param  - the x offset of the pixel in pixel coordinates
         * @param  - the y offset of the pixel in pixel coordinates
         */
        getPixel(x: number, y: number): Color;

        /**
         * Gets the color of a pixel in the raster.
         * @param  - the offset of the pixel as a point in pixel coordinates
         */
        getPixel(point: TPoint): Color;

        /**
         * Sets the color of the specified pixel to the specified color
         * @param  - the x offset of the pixel in pixel coordinates
         * @param  - the y offset of the pixel in pixel coordinates
         * @param  - the color that the pixel will be set to
         */
         ...
         * @param  - the color that the pixel will be set to
         */
        setPixel(point: TPoint, color: Color): void;

        /**
         *
         * @param  undefined
         */
        createImageData(size: TSize): ImageData;

        /**
         *
         * @param  undefined
         */
        getImageData(rect: TRectangle): ImageData;
         ...
         * @param  undefined
         */
        setImageData(data: ImageData, point: TPoint): void
    }

    /**
     * A PlacedSymbol represents an instance of a symbol which has been placed in a Paper.js project.
     */
    declare export class PlacedSymbol mixins TItem {

        /**
         * Creates a new PlacedSymbol TItem.
         * @param  - the symbol to place
         * @param  [optional] - the center point of the placed symbol
         */
        constructor(symbol: Symbol, point?: TPoint): this;
    ...
    /**
     * A THitResult object contains information about the results of a hit test. It is returned by item.hitTest(point) and project.hitTest(point).
     */
    declare export class THitResult {
        ...
        /**
         * If the THitResult has a hitResult.type of 'bounds', this property describes which corner of the bounding rectangle was hit.
        ...
        /**
         * If the THitResult has a type of 'curve' or 'stroke', this property gives more information about the exact position that was hit on the path.
         */
        location: CurveLocation;

        /**
         * If the THitResult has a type of 'pixel', this property refers to the color of the pixel on the Raster that was hit.
         */
        color: Color;

        /**
         * If the THitResult has a type of 'stroke', 'segment', 'handle-in' or 'handle-out', this property refers to the segment that was hit or that is closest to the hitResult.location on the curve.
         */
        segment: Segment;
    ...
    /**
     * The TPathItem class is the base for any items that describe paths and offer standardised methods for drawing and path manipulation, such as TPath and CompoundPath.
     */
    declare export class TPathItem mixins TItem {
        ...
        /**
         * Returns all intersections between two TPathItem items as an array of CurveLocation objects. CompoundPath items are also supported.
         * @param  - the other item to find the intersections with
         * @param  [optional] - specifies whether the returned CurveLocation objects should be sorted by path and offset, default: false
         */
        getIntersections(path: TPathItem, sorted?: boolean): CurveLocation[];
        ...
        /**
         * On a normal empty TPath, the point is simply added as the path's first segment. If called on a CompoundPath, a new TPath is created as a child and the point is added as its first segment.
         * @param  - the path's first segment
         */
        moveTo(point: TPoint): void;

        /**
         * Draw a line from the current point to the given point
         * @param  - the end point of the line
         */
        lineTo(point: TPoint): void;

        /**
         * Adds a cubic bezier curve to the path, defined by two handles and a to point.
         * @param  - The first control point handle for the curve
         * @param  - The second control point handle for the curve
         * @param  - The end control point of the curve
         */
        cubicCurveTo(handle1: TPoint, handle2: TPoint, to: TPoint): void;

        /**
         * Adds a quadratic bezier curve to the path, defined by a handle and a to point.
         * @param  - The control point for the curve
         * @param  - The end control point of the curve
         */
        quadraticCurveTo(handle: TPoint, to: TPoint): void;
         ...
         * @param  - the point through which the curve should go
         * @param  - the point where the curve should end
         * @param  [optional] - default: 0.5
         */
        curveTo(through: TPoint, to: TPoint, parameter?: number): void;
         ...
         * @param  - the point where the arc should pass through
         * @param  - the point where the arc should end
         */
        arcTo(through: TPoint, to: TPoint): void;
         ...
         * @param  - the point where the arc should end
         * @param  [optional] - specifies whether the arc should be drawn in clockwise direction. optional, default: true
         */
        arcTo(to: TPoint, clockwise?: boolean): void;

        /**
         * Closes the path. When closed, Paper.js connects the first and last segment of the path with an additional curve.
         * @param  - controls whether the method should attempt to merge the first segment with the last if they lie in the same location.
         */
        closePath(join: boolean): void;

        /**
         * If called on a CompoundPath, a new TPath is created as a child and a point is added as its first segment relative to the position of the last segment of the current path.
         * @param  -
         */
        moveBy(to: TPoint): void;

        /**
         * Adds a segment relative to the last segment point of the path.
         * @param  - the vector which is added to the position of the last segment of the path, to get to the position of the new segment.
         */
        lineBy(to: TPoint): void;
         ...
         * @param  [optional] - default 0.5
         */
        curveBy(through: TPoint, to: TPoint, parameter?: number): void;
         ...
         * @param  -
         */
        cubicCurveBy(handle1: TPoint, handle2: TPoint, to: TPoint): void;
         ...
         * @param  -
         */
        quadraticCurveBy(handle: TPoint, to: TPoint): void;
         ...
         * @param  -
         */
        arcBy(through: TPoint, to: TPoint): void;
         ...
         */
        subtract(path: TPathItem): TPathItem;
         ...
         */
        exclude(path: TPathItem): TPathItem;
         ...
         */
        divide(path: TPathItem): TPathItem
    }
    declare module 'TPath' {
        declare     export class Line mixins TPath {

            /**
             * Creates a linear path item from two points describing a line.
             * @param  - the line's starting point
             * @param  - the line's ending point
             */
            constructor(from: TPoint, to: TPoint): this;

            /**
             * Creates a linear path item from the properties described by an object literal.
             * @param  - an object literal containing properties describing the path's attributes
             */
            constructor(object: any): this
        }
        declare     export class TCircle mixins TPath {
             ...
             * @param  - the radius of the circle
             */
            constructor(center: TPoint, radius: number): this;
        ...
        declare     export class TRectangle mixins TPath {

            /**
             * Creates a rectangular path item, with optionally rounded corners.
             * @param  - the rectangle object describing the geometry of the rectangular path to be created.
             * @param  [optional] - the size of the rounded corners default: null
             */
            constructor(rectangle: TRectangle, radius?: number): this;
        ...
        declare     export class Ellipse mixins TPath {

            /**
             * Creates an elliptical path item.
             * @param  - the rectangle circumscribing the ellipse
             */
            constructor(rectangle: TRectangle): this;
        ...
        declare     export class Arc mixins TPath {

            /**
             * Creates a circular arc path item
             * @param  - the starting point of the circular arc
             * @param  - the point the arc passes through
             * @param  - the end point of the arc
             */
            constructor(from: TPoint, through: TPoint, to: TPoint): this;
        ...
        declare     export class RegularPolygon mixins TPath {

            /**
             * Creates a regular polygon shaped path item.
             * @param  - the center point of the polygon
             * @param  - the number of sides of the polygon
             * @param  - the radius of the polygon
             */
            constructor(center: TPoint, sides: number, radius: number): this;
        ...
        declare     export class Star mixins TPath {
             ...
             * @param  - the center point of the star
             * @param  - the number of points of the star
             * @param  undefined
             * @param  undefined
             */
            constructor(center: TPoint, points: number, radius1: number, radius2: number): this;
    ...
    declare export class CompoundPath mixins TPathItem {
        ...
        /**
         * All the curves contained within the compound-path, from all its child TPath items.
         * Read Only
         */
        curves: Curve[];
    ...
    declare export class Segment {
         ...
         * @param  [optional] - the anchor point of the segment default: {x: 0, y: 0}
         * @param  [optional] - the handle point relative to the anchor point of the segment that describes the in tangent of the segment default: {x: 0, y: 0}
         * @param  [optional] - the handle point relative to the anchor point of the segment that describes the out tangent of the segment default: {x: 0, y: 0}
         */
        constructor(point?: TPoint, handleIn?: TPoint, handleOut?: TPoint): this;

        /**
         * Creates a new Segment object.
         * @param  - an object literal containing properties to be set on the segment.
         */
        constructor(object?: any): this;
         ...
         * @param  - the matrix to transform the segment by
         */
        transform(matrix: TMatrix): void
    }
    ...
    declare export class Curve {
         ...
         * @param  : TPoint
         */
        constructor(point1: TPoint, handle1: TPoint, handle2: TPoint, point2: TPoint): this;
         ...
         * @param  [optional] - the offset on the curve at which to split, or the curve time parameter if isParameter is true  default: 0.5
         * @param  [optional] - pass true if offset is a curve time parameter. default: false
         */
         ...
         * @param  [optional] - pass true if offset is a curve time parameter. default: false
         */
        split(offset?: number, isParameter?: boolean): TPath;
         ...
         * @param  [optional] -
         */
        getParameterAt(offset: TPoint, start?: number): number;

        /**
         * Returns the curve time parameter of the specified point if it lies on the curve, null otherwise.
         * @param  - the point on the curve.
         */
        getParameterOf(point: TPoint): number;

        /**
         * Calculates the curve location at the specified offset or curve time parameter.
         * @param  - the offset on the curve, or the curve time parameter if isParameter is true
         * @param  [optional] - pass true if offset is a curve time parameter.  default: false
         */
         ...
         * @param  [optional] - pass true if offset is a curve time parameter. default: false
         */
        getPointAt(offset: number, isParameter?: boolean): TPoint;
         ...
         * @param  [optional] - pass true if offset is a curve time parameter. default: false
         */
        getTangentAt(offset: number, isParameter?: boolean): TPoint;
         ...
         * @param  [optional] - pass true if offset is a curve time parameter. default: false
         */
        getNormalAt(offset: number, isParameter?: boolean): TPoint;
         ...
         * @param  - the offset on the curve, or the curve time parameter if isParameter is true
         * @param  - pass true if offset is a curve time parameter. default: false
         */
        getCurvatureAt(offset: number, isParameter?: boolean): TPoint
    }

    /**
     * CurveLocation objects describe a location on Curve objects, as defined by the curve parameter, a value between 0 (beginning of the curve) and 1 (end of the curve). If the curve is part of a TPath item, its index inside the path.curves array is also provided.
     * The class is in use in many places, such as path.getLocationAt(offset, isParameter), path.getLocationOf(point), TPath#getNearestLocation(point),{@linkPathItem#getIntersections(path), etc.
     */
    declare export class CurveLocation {
         ...
         * @param  -
         */
        constructor(curve: Curve, parameter: number, point: TPoint): this;
        ...
        /**
         * The index of the curve within the path.curves list, if the curve is part of a TPath item.
         * Read Only.
         */
        index: number;
    ...
    */
    declare export class Project {
         ...
         * @param  - the HTML canvas element that should be used as the element for the view, or an ID string by which to find the element.
         */
    ...
    declare export class Symbol {
         ...
         * @param  - the source item which is copied as the definition of the symbol
         * @param  [optional] - default: false
         */
        constructor(item: TItem, dontCenter?: boolean): this;
         ...
         * @param  [optional] - The position of the placed symbol.
         */
        place(position?: TPoint): PlacedSymbol;
     ...
     * All properties of Style are also reflected directly in TItem, i.e.: item.fillColor.
    ...
    */
    ...
    declare export class Color {
         ...
         * @param  - the amount of red in the color as a value between 0 and 1
         * @param  - the amount of green in the color as a value between 0 and 1
         * @param  - the amount of blue in the color as a value between 0 and 1
         * @param  [optional] - the alpha of the color as a value between 0 and 1
         */
        constructor(red: number, green: number, blue: number, alpha?: number): this;

        /**
         * Creates a gray Color object.
         * @param  - the amount of gray in the color as a value between 0 and 1
         * @param  [optional] - the alpha of the color as a value between 0 and 1
         */
         ...
         * @param  - an object describing the components and properties of the color.
         */
         ...
         * @param  [optional] -
         */
        constructor(color: Gradient, origin: TPoint, destination: TPoint, highlight?: TPoint): this;

        /**
         * Creates a RGB Color object.
         * @param  - the RGB color in hex, i.e. #000000
         */
         ...
         * @param  - String('rgb'|'gray'|'hsb'|'hsl') the color type to convert to.
         */
         ...
         * @param  - the color to compare with
         */
         ...
         * @param  - whether to return the color in hexadecial representation or as a CSS RGB / RGBA string.
         */
        toCSS(hex: boolean): string;

        /**
         * Transform the gradient color by the specified matrix.
         * @param  - the matrix to transform the gradient color by
         */
        transform(matrix: TMatrix): void
    }
    ...
    declare export class Gradient {
         ...
         * @param  - the gradient to check against
         */
    ...
    declare export class GradientStop {
         ...
         * @param  [optional] - the color of the stop, default: new Color(0, 0, 0)
         * @param  [optional] - the position of the stop on the gradient ramp as a value between 0 and 1, default: 0
         */
    ...
    /**
     * The TView object wraps an HTML element and handles drawing and user interaction through mouse and keyboard for it. It offer means to scroll the view, find the currently visible bounds in project coordinates, or the center, both useful for constructing artwork that should appear centered on screen.
     */
    declare export class TView {
        ...
        */
         ...
         * @param  - the vector to scroll by
         */
        scrollBy(point: TPoint): void;
         ...
         * @param  -
         */
        viewToProject(point: TPoint): TPoint;

        /**
         * Attach an event handler to the view.
         * @param  - String('frame'|'resize') the event type
         * @param  - The function to be called when the event occurs
         */
        on(type: string, callback: (event: Event) => void): TItem;
         ...
         * @param  - The function to be detached
         */
        off(type: string, callback: (event: Event) => void): TItem;

        /**
         * Detach one or more event handlers from the view.
         * @param  -  an object literal containing one or more of the following properties: frame, resize
         */
        off(param: any): TItem;
    ...
    declare export class ToolEvent mixins Event {
        ...
        /**
         * The item at the position of the mouse (if any). If the item is contained within one or more TGroup or CompoundPath items, the most top level group or compound path that it is contained within is returned.
         */
        item: TItem;
    ...
    declare export class Key {
         ...
         * @param  - One of: 'backspace', 'enter', 'shift', 'control', 'option', 'pause', 'caps-lock', 'escape', 'space', 'end', 'home', 'left', 'up', 'right', 'down', 'delete', 'command'
         */
    ...
    /**
     * The TTextItem type allows you to create typography. Its functionality is inherited by different text item types such as TPointText, and AreaText (coming soon). They each add a layer of functionality that is unique to their type, but share the underlying properties and functions that they inherit from TTextItem.
     */
    declare export class TTextItem mixins TItem {
    ...
    /**
     * A TPointText item represents a piece of typography in your Paper.js project which starts from a certain point and extends by the amount of characters contained in it.
     */
    declare export class TPointText mixins TTextItem {

        /**
         * Creates a point text item
         * @param  - the position where the text will start
         */
        constructor(point: TPoint): this;
        ...
        /**
         * The TPointText's anchor point
         */
        point: TPoint
    }

    /**
     * A Javascript TMouseEvent wrapper
     */
    declare export class TMouseEvent mixins Event {
        constructor(type: string, event: NativeMouseEvent, point: TPoint, target: TItem, delta: TPoint): this;
